      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 form-group form-inline">
            <label class="font-weight-bold" for="">Search By ID and  Name :&emsp;</label>
            ...
            &emsp;<input type="number" class="form-control" id="by_invoice_number" placeholder="By Invoice" onkeyup="searchPurchase(this.value, 'INVOICE_NUMBER');"><br><br>
            &emsp;<label class="font-weight-bold" for="">By Purchase Date and Amount Type:&emsp;</label>
