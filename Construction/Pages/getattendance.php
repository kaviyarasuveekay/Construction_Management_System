...
<table width="1120" border="1" align="center">
      ...
      ?>
          ...
          <table width="200px" style="margin-left:335px;height:30px;font-size:20px;margin-top:50px;margin-bottom:40px">
              <tr>
                  <td> Total Strength : <input class="form-control" type="text" id="txtStrength" value="<?php print $s; ?>" size="10" disabled="disabled"/></td>
                </tr>
              <tr>
                  <td> Total Absent : <input class="form-control" type="text" id="txtAbsent" value="<?php print $s; ?>" size="10" disabled="disabled"/></td>
                </tr>
                <tr>
                  <td> Total Present : <input class="form-control" type="text" id="txtPresent" value="0" size="10"  disabled="disabled"/></td>
                </tr>
