<?php
  ...
  if($con) {
    ...
    if(isset($_GET['action']) && $_GET['action'] == "worker")
      showSuggestions($con, "workers", "worker");

    if(isset($_GET['action']) && $_GET['action'] == "material")
      showSuggestions($con, "materials", "material");

    if(isset($_GET['action']) && $_GET['action'] == "customer_address")
      getValue($con, $_GET['action'], "ADDRESS");

    if(isset($_GET['action']) && $_GET['action'] == "customer_contact_number")
