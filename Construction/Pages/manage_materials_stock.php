...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Manage Materials Stock</title>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="text" class="form-control" id="by_name" placeholder="By Material Name" onkeyup="searchMedicineStock(this.value, 'NAME');">
            &emsp;<input type="text" class="form-control" id="by_generic_name" placeholder="By Remarks" onkeyup="searchMedicineStock(this.value, 'REMARKS');">
            ...
            &emsp;<button class="btn btn-danger font-weight-bold" onclick="searchMedicineStock('5', 'QUANTITY');">Low of Stock</button>
            	...
            	<table class="table table-bordered table-striped table-hover">
            		<thead>
            			<tr>
            				...
            				<th style="width: 14%;">Matrial Name</th>
                ...
                <tbody id="medicines_stock_div">
                  <?php
                    ...
                    if(isset($_GET['out_of_stock']))
                      echo "<script>searchMedicineStock('5', 'QUANTITY');</script>";
